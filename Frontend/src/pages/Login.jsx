        ...
        <div className=' h-15 w-15 rounded-4xl bg-black flex justify-center overflow-hidden'>
          ...
          <div className="w-full flex flex-col gap-4 items-center justify-center">
            ...
            <div className="flex flex-col text-center justify-center">
              ...
              <span className="text-sm">Not on here yet? <Link to="/Register" className="text-black dark:text-violet-400 font-bold text-sm cursor-pointer hover:underline ml-2">Register</ Link></span>
            </div>
